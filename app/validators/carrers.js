...
const create = Joi.object({
  ...
  responsibilities: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
skills: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
qualifications: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
...
const update = Joi.object({
    ...
    experience: Joi.string().optional().allow('', null).error(commonService.getValidationMessage),
    location: Joi.string().required().error(commonService.getValidationMessage),
    responsibilities: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
    skills: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
    qualifications: Joi.array().items(Joi.string()).allow(null).optional().error(commonService.getValidationMessage),
